...
void main() {
  ...
  final blogList = Success(data: const [
    Blog(id: "1", title: "Blog 1", content: "Halo", imagePreviewURL: "", releaseDate: ""),
    Blog(id: "2", title: "Blog 2", content: "Halo", imagePreviewURL: "", releaseDate: ""),
    Blog(id: "3", title: "Blog 3", content: "Halo", imagePreviewURL: "", releaseDate: "")
  ]);

  test(
    "Should get blog list from the repository",
     () async {
